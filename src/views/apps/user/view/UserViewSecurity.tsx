// src\views\apps\user\view\UserViewSecurity.tsx
...
const UserViewSecurity = () => {
  // ** States
  const [defaultValues, setDefaultValues] = useState<any>({ mobile: '+84 000 000' })
  ...
  const handleChangePassword = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Here you might want to add some front-end validation before sending the request.
    try {
    ...
    <Grid container spacing={6}>
        ...
        <Card>
          ...
          <CardContent>
            <Alert icon={false} severity='warning' sx={{ mb: 6 }}>
              ...
              Minimum 6 characters number & symbol
            </Alert>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          />
          <CardContent>
            <Typography sx={{ fontWeight: 500, fontSize: '0.875rem' }}>-</Typography>
